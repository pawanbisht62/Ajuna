...
pub(crate) struct AvatarForgerV1<'a, T: Config>(pub PhantomData<&'a T>);
	...
	T: Config,
{
	fn forge_with(
		...
		self.can_be_forged(&input_leader, &input_sacrifices, season)?;
